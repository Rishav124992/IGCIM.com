...
// // ✅ STEP 2: Shuffle and take only 70
...
// shuffle(quizData);              // shuffle full array
// const selectedQuiz = quizData.slice(0, 70);  // only 70 random questions

// // ✅ STEP 3: Use selectedQuiz instead of quizData
...
//     questionEl.textContent = `Q${currentQuestion + 1} of ${selectedQuiz.length}: ${q.question}`;
//     optionsEl.innerHTML = "";
...
//   resultEl.textContent = `🎉 You scored ${score} out of ${selectedQuiz.length}`;
// }
...
function showResult() {
  ...
  resultEl.innerText = `Your Score: ${score} out of ${selectedQuestions.length}`;
}
